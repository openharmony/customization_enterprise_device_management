...
namespace EdmReturnErrCode {
    ...
    constexpr uint32_t CERTIFICATE_REACHED_LIMIT = 9201006;
    constexpr uint32_t CERTIFICATE_IS_INVALID = 9201007;
    ...
    constexpr uint32_t INSTALL_APP_INSUFFICIENT_DISK_SPACE = 9201022;
    constexpr uint32_t INSTALL_APP_ENTERPRISE_DISALLOWED = 9201023;
    constexpr uint32_t INSTALL_APP_PARSE_FAILED = 9201024;
    constexpr uint32_t INSTALL_APP_SIGNATURE_VERIFY_FAILED = 9201025;
    constexpr uint32_t INSTALL_APP_PATH_INVALID_OR_TOO_LARGE = 9201026;
    constexpr uint32_t INSTALL_APPS_CONFIGURATION_MISMATCH = 9201027;
    constexpr uint32_t INSTALL_APP_ISOLATION_MODE_NOT_SUPPORTED = 9201028;
    constexpr uint32_t INSTALL_APP_VERSION_TOO_EARLY = 9201029;
    constexpr uint32_t INSTALL_APP_VERSION_CODE_NOT_GREATER = 9201030;
    constexpr uint32_t INSTALL_APP_DEPENDANT_MODULE_NOT_EXIST = 9201031;
    constexpr uint32_t INSTALL_APP_USER_ID_NOT_FOUND = 9201032;
    constexpr uint32_t INSTALL_APP_OVERLAY_CHECK_FAILED = 9201033;
    constexpr uint32_t INSTALL_APP_MISSING_REQUIRED_PERMISSIONS_FOR_HSP = 9201034;
    constexpr uint32_t INSTALL_APP_SHARED_LIBRARIES_NOT_ALLOWED = 9201035;
    constexpr uint32_t INSTALL_APP_URI_INCORRECT = 9201036;
    constexpr uint32_t INSTALL_APP_PERMISSION_CONFIGURATION_INCORRECT = 9201037;
    constexpr uint32_t INSTALL_APP_CODE_SIGNATURE_VERIFICATION_FAILURE = 9201038;
    constexpr uint32_t INSTALL_APP_ENTERPRISE_DEVICE_VERIFICATION_FAILURE = 9201039;
    constexpr uint32_t ACCOUNT_NUMBER_UPPER_LIMIT = 9201040;
...
// Error code for EDM_TOOLS_COMMAND: 0x2060000,value:33947648
...
// Error code for ADD_AUTO_START_APP: 0x2070000,value:34013184
...
// Error code for ADMIN_EXTENSION: 0x2080000,value:34078720
