...
public:
    ...
    virtual ErrCode HandleDevicePolicyNew(uint32_t code, MessageParcel &data, MessageParcel &reply,
        int32_t userId) = 0;
    virtual ErrCode GetDevicePolicyNew(uint32_t code, MessageParcel &data, MessageParcel &reply,
        int32_t userId) = 0;
