...
enum EdmInterfaceCode : uint32_t {
    ...
    IS_BYOD_ADMIN = 22,
    ENABLE_DEVICE_ADMIN = 25,
    DISABLE_DEVICE_ADMIN = 26,
    GET_ENTERPRISE_MANAGED_TIPS = 27,
    GET_ADMIN_INFOS = 31,
    IS_SUPER_ADMIN_BY_WANT = 32,
    NOTIFY_UNMOUNT_EXTERNAL_STORAGE_DEVICE = 34,
    ...
    DISALLOWED_RANDOM_MAC_ADDRESS = 1117,
    DISALLOWED_EXTERNAL_STORAGE_CARD = 1118,
    ALLOW_RUNNING_BUNDLES = 1119,
    DISALLOW_UNMUTE_DEVICE = 1120,
    DISABLED_HDC_REMOTE = 1121,
    INSTALL_MARKET_APPS = 1122,
    DISABLE_RUNNING_BINARY_APP = 1123,
    DISALLOW_VIRTUAL_SERVICE = 1124,
    MANAGE_USER_NON_STOP_APPS = 1125,
    HANG_UP_CALLING = 1126,
    MANAGE_FREEZE_EXEMPTED_APPS = 1127,
    SET_EYE_COMFORT_MODE = 1128,
    SET_NETWORK_INTERFACE_CONFIG = 1129,
    DISALLOWED_FILEBOOST_OPEN = 1130,
    SET_DEFAULT_INPUT_METHOD = 1131,
    INSTALL_ENTERPRISE_RE_SIGNATURE_CERTIFICATE = 1132,
    DISALLOW_MODIFY_WALLPAPER = 1133,
    ...
    DISALLOWED_DISTRIBUTED_TRANSMISSION_FULL = 1156,
    DISABLE_SCREEN_LOCK = 1157,
    ENABLE_SELF_DEVICE_ADMIN = 1158,
    DISALLOWED_DEVICE_SUDO = 1159,
    GET_APPLICATION_WINDOW_STATES = 1160,
    ALLOWED_COLLABORATION_SERVICE_BUNDLES = 1161,
    DISALLOW_RS232 = 1162,
    OTA_UPDATE_NONCE = 1163,
    MANAGE_NORMAL_OS_ACCOUNT = 1164,
    DISALLOWED_TRAFFIC_REDIRECTION = 1165,
    DISALLOWED_PERMISSIVE_USB_DEVICES = 1166,
    DISALLOWED_PERMISSION = 1167,
    ALLOWED_PERMISSION_BUNDLE = 1168,
    ACTIVATE_NORMAL_OS_ACCOUNT = 1169,
    LOCAL_HOTA_DOMAIN = 1170,
    ...
    EXEMPTION_RESOURCE = 1177,
    SYSTEM_TIMER_OPERATION = 1178,
    GET_USB_SERIAL_NUMBER = 1179,
    ALLOWED_PRINTER_IP_ADDRESS_FOR_DEVICE = 1180,
    ALLOWED_PRINTER_IP_ADDRESS_FOR_ACCOUNT = 1181,
    DISABLE_SATA_ODD_BURN = 1182,
    ALLOWED_ODD_BURN_USB_DEVICES = 1183,
    EXTERNAL_STORAGE_INTERCEPT_ENABLE = 1184,
    EXTERNAL_STORAGE_DEVICE_MOUNT_POLICY = 1185,
    DISALLOWED_PACKET_FILTERING = 1186,
