...
public:
    ...
    int32_t DisallowFingerprintAuth(const AppExecFwk::ElementName &admin, bool isDisabled);
    int32_t IsFingerprintAuthDisallowed(AppExecFwk::ElementName *admin, bool &result);
