...
private:
    ...
    static bool CheckParameters(const std::map<std::string, std::string> &parameters, ApnInfo &info);
    ...
    static napi_value ConvertApnInfoToJS(napi_env env, const ApnInfo &apnInfo);
};
} // namespace EDM
} // namespace OHOS
