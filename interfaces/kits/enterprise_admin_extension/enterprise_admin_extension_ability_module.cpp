...
extern const char _binary_enterprise_admin_extension_ability_js_start[];
extern const char _binary_enterprise_admin_extension_ability_js_end[];
...
{
    if (buf != nullptr) {
        *buf = _binary_enterprise_admin_extension_ability_js_start;
    }

    if (bufLen != nullptr) {
        *bufLen = _binary_enterprise_admin_extension_ability_js_end -
            _binary_enterprise_admin_extension_ability_js_start;
    }
}
...
{
    if (buf != nullptr) {
        *buf = _binary_enterprise_admin_extension_ability_abc_start;
    }
    if (buflen != nullptr) {
        *buflen = _binary_enterprise_admin_extension_ability_abc_end -
            _binary_enterprise_admin_extension_ability_abc_start;
    }
}