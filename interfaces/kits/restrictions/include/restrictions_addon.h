...
private:
    ...
    static napi_value DisallowMicrophone(napi_env env, napi_callback_info info);
    static napi_value IsMicrophoneDisallowed(napi_env env, napi_callback_info info);
