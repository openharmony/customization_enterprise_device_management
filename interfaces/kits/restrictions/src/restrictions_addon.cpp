...
std::unordered_map<std::string, uint32_t> RestrictionsAddon::labelCodeMap = {
    ...
    {EdmConstants::Restrictions::LABEL_DISALLOWED_POLICY_SECURE_ERAS, EdmInterfaceCode::POLICY_CODE_END + 27},
};
...
std::unordered_map<std::string, uint32_t> RestrictionsAddon::labelCodeMapForAccount = {
    ...
    {EdmConstants::Restrictions::LABEL_DISALLOWED_POLICY_SUPERHUB,
