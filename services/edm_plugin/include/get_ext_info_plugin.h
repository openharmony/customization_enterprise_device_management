...
#ifndef SERVICES_EDM_PLUGIN_INCLUDE_GET_EXT_INFO_PLUGIN_H
#define SERVICES_EDM_PLUGIN_INCLUDE_GET_EXT_INFO_PLUGIN_H

#include "iplugin.h"

namespace OHOS {
namespace EDM {
class GetExtInfoPlugin : public IPlugin {
public:
    GetExtInfoPlugin();
...
#endif // SERVICES_EDM_PLUGIN_INCLUDE_GET_EXT_INFO_PLUGIN_H
