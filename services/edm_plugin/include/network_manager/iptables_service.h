...
#ifndef SERVICES_EDM_PLUGIN_INCLUDE_IPTABLES_IPTABLES_SERVICE_H
#define SERVICES_EDM_PLUGIN_INCLUDE_IPTABLES_IPTABLES_SERVICE_H
...
public:
    static std::shared_ptr<IptablesService> GetInstance();
...
private:
    ...
    bool ExistDenyFirewallRule();
    bool ExistDenyDomainRule();
