...
#ifndef SERVICES_EDM_INCLUDE_UTILS_PASSWORD_POLICY_SERIALIZER_H
#define SERVICES_EDM_INCLUDE_UTILS_PASSWORD_POLICY_SERIALIZER_H
 ...
 */
class PasswordSerializer : public IPolicySerializer<PasswordPolicy>,
    public DelayedSingleton<PasswordSerializer> {
public:
...
#endif // SERVICES_EDM_INCLUDE_UTILS_PASSWORD_POLICY_SERIALIZER_H
