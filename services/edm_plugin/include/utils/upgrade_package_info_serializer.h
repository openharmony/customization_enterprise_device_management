...
#ifndef SERVICES_EDM_PLUGIN_INCLUDE_UPGRADE_PACKAGE_INFO_SERIALIZER_H
#define SERVICES_EDM_PLUGIN_INCLUDE_UPGRADE_PACKAGE_INFO_SERIALIZER_H
...
#endif // SERVICES_EDM_PLUGIN_INCLUDE_UPGRADE_PACKAGE_INFO_SERIALIZER_H