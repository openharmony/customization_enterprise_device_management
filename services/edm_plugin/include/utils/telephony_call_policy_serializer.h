...
#ifndef SERVICES_EDM_INCLUDE_UTILS_TELEPHONY_CALL_POLICY_SERIALIZER_H
#define SERVICES_EDM_INCLUDE_UTILS_TELEPHONY_CALL_POLICY_SERIALIZER_H
...
#endif // SERVICES_EDM_INCLUDE_UTILS_TELEPHONY_CALL_POLICY_SERIALIZER_H