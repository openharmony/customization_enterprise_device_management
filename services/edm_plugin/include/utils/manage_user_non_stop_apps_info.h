...
#ifndef SERVICES_EDM_INCLUDE_UTILS_MANAGE_USER_NON_STOP_APP_INFO_H
#define SERVICES_EDM_INCLUDE_UTILS_MANAGE_USER_NON_STOP_APP_INFO_H
...
class ManageUserNonStopAppInfo {
public:
    bool Marshalling(MessageParcel &parcel) const;
    static bool Unmarshalling(MessageParcel &parcel, ManageUserNonStopAppInfo &appInfo);
    ...
    bool operator<(const ManageUserNonStopAppInfo &other) const
    {
...
#endif // SERVICES_EDM_INCLUDE_UTILS_MANAGE_USER_NON_STOP_APP_INFO_H