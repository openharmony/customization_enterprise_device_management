...
#ifndef SERVICES_EDM_INCLUDE_WATERMARK_APPLICATION_OBSERVER_H
#define SERVICES_EDM_INCLUDE_WATERMARK_APPLICATION_OBSERVER_H
...
#endif // SERVICES_EDM_INCLUDE_WATERMARK_APPLICATION_OBSERVER_H