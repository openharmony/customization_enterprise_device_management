...
#ifndef SERVICES_EDM_PLUGIN_INCLUDE_DISALLOW_BLUETOOTH_PLUGIN_H
#define SERVICES_EDM_PLUGIN_INCLUDE_DISALLOW_BLUETOOTH_PLUGIN_H
...
#endif // SERVICES_EDM_PLUGIN_INCLUDE_DISALLOW_BLUETOOTH_PLUGIN_H
