...
#ifndef SERVICES_EDM_PLUGIN_INCLUDE_SECURITY_MANAGER_UNLOCK_POLICY_PLUGIN_H
#define SERVICES_EDM_PLUGIN_INCLUDE_SECURITY_MANAGER_UNLOCK_POLICY_PLUGIN_H

#include "iplugin.h"

namespace OHOS {
namespace EDM {
class UnlockPolicyPlugin : public IPlugin {
public:
    UnlockPolicyPlugin();
