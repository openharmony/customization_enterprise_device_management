...
void DisableRunningBinaryAppPlugin::InitPlugin(std::shared_ptr<IPluginTemplate<DisableRunningBinaryAppPlugin, bool>> ptr)
{
    ...
    persistParam_ = "persist.edm.running_binary_app_disable";
}
} // namespace EDM
} // namespace OHOS
