...
const bool REGISTER_RESULT = IPluginManager::GetInstance()->AddPlugin(std::make_shared<OtaUpdateNoncePlugin>());
  
OtaUpdateNoncePlugin::OtaUpdateNoncePlugin()
{
    EDMLOGI("OtaUpdateNoncePlugin InitPlugin...");
    policyCode_ = EdmInterfaceCode::OTA_UPDATE_NONCE;
    policyName_ = PolicyName::POLICY_OTA_UPDATE_NONCE;
