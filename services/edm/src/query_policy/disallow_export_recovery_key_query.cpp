...
namespace OHOS {
namespace EDM {
std::string DisallowExportRecoveryKeyQuery::GetPolicyName()
{
    return PolicyName::POLICY_DISALLOWED_EXPORT_RECOVERY_KEY;
}

std::string DisallowExportRecoveryKeyQuery::GetPermission(
    IPlugin::PermissionType, const std::string &permissionTag)
{
    return EdmPermission::PERMISSION_ENTERPRISE_MANAGE_RESTRICTIONS;
}

ErrCode DisallowExportRecoveryKeyQuery::QueryPolicy(
