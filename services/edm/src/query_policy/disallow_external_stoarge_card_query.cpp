...
namespace OHOS {
namespace EDM {
std::string DisableExternalStorageCardQuery::GetPolicyName()
{
    return PolicyName::POLICY_DISALLOWED_EXTERNAL_STORAGE_CARD;
}

std::string DisableExternalStorageCardQuery::GetPermission(
    IPlugin::PermissionType, const std::string &permissionTag)
{
    return EdmPermission::PERMISSION_ENTERPRISE_MANAGE_RESTRICTIONS;
}

ErrCode DisableExternalStorageCardQuery::QueryPolicy(
