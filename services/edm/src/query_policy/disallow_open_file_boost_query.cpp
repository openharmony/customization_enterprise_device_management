...
namespace OHOS {
namespace EDM {
std::string DisallowOpenFileBoostQuery::GetPolicyName()
{
    return PolicyName::POLICY_DISALLOWED_OPEN_FILE_BOOST;
}

std::string DisallowOpenFileBoostQuery::GetPermission(
    IPlugin::PermissionType, const std::string &permissionTag)
{
    return EdmPermission::PERMISSION_ENTERPRISE_MANAGE_RESTRICTIONS;
}

ErrCode DisallowOpenFileBoostQuery::QueryPolicy(
