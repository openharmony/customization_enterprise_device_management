...
namespace OHOS {
namespace EDM {
std::string DisallowMultiWindowQuery::GetPolicyName()
{
    return PolicyName::POLICY_DISALLOWED_MULTI_WINDOW;
}

std::string DisallowMultiWindowQuery::GetPermission(
    IPlugin::PermissionType, const std::string &permissionTag)
{
    return EdmPermission::PERMISSION_ENTERPRISE_MANAGE_RESTRICTIONS;
}

ErrCode DisallowMultiWindowQuery::QueryPolicy(
