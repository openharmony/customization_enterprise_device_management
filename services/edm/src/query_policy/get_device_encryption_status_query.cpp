...
ErrCode GetDeviceEncryptionStatusQuery::QueryPolicy(std::string &policyData, MessageParcel &data, MessageParcel &reply,
    int32_t userId)
{
    EDMLOGI("GetDeviceEncryptionStatusQuery OnGetPolicy.");
