...
namespace OHOS {
namespace EDM {
std::string DisallowDistributedTransmissionQuery::GetPolicyName()
{
    return PolicyName::POLICY_DISALLOWED_DISTRIBUTED_TRANSMISSION;
}

std::string DisallowDistributedTransmissionQuery::GetPermission(
    IPlugin::PermissionType, const std::string &permissionTag)
{
    return EdmPermission::PERMISSION_ENTERPRISE_MANAGE_RESTRICTIONS;
}

ErrCode DisallowDistributedTransmissionQuery::QueryPolicy(
