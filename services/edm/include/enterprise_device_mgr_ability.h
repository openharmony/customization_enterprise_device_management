...
public:
    ...
    ErrCode IsSelfSuperAdmin(bool &isSuper) override;
    ErrCode IsFeatureSupported(int32_t feature, bool &supported) override;
    ...
    ErrCode GetAdminInfos(std::vector<std::shared_ptr<AAFwk::Want>> &wants) override;
