...
#ifndef SERVICES_EDM_INCLUDE_CONNECTION_ENTERPRISE_OOBE_CONNECTION_H
#define SERVICES_EDM_INCLUDE_CONNECTION_ENTERPRISE_OOBE_CONNECTION_H
...
public:
    EnterpriseOobeConnection(const AAFwk::Want &want, uint32_t code, uint32_t userId, int32_t type)
        : IEnterpriseConnection(want, code, userId), type_(type) {}

    ~EnterpriseOobeConnection() override;
...
#endif // SERVICES_EDM_INCLUDE_CONNECTION_ENTERPRISE_OOBE_CONNECTION_H