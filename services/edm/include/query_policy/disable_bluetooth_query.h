...
#ifndef SERVICES_EDM_INCLUDE_QUERY_POLICY_DISALBE_BLUETOOTH_QUERY_H
#define SERVICES_EDM_INCLUDE_QUERY_POLICY_DISALBE_BLUETOOTH_QUERY_H
...
class DisableBluetoothQuery : public IPolicyQuery {
public:
...
#endif // SERVICES_EDM_INCLUDE_QUERY_POLICY_DISALBE_BLUETOOTH_QUERY_H
