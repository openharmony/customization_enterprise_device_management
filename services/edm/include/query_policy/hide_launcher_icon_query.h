...
#ifndef SERVICES_EDM_INCLUDE_QUERY_POLICY_HIDE_LAUNCHER_ICON_QUERY_H
#define SERVICES_EDM_INCLUDE_QUERY_POLICY_HIDE_LAUNCHER_ICON_QUERY_H
...
class HideLauncherIconQuery : public IPolicyQuery {
public:
    ~HideLauncherIconQuery() override = default;
...
#endif // SERVICES_EDM_INCLUDE_QUERY_POLICY_HIDE_LAUNCHER_ICON_QUERY_H