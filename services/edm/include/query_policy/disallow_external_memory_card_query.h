...
#ifndef SERVICES_EDM_INCLUDE_QUERY_POLICY_DISALLOW_EXTERNAL_MEMORY_CARD_QUERY_H
#define SERVICES_EDM_INCLUDE_QUERY_POLICY_DISALLOW_EXTERNAL_MEMORY_CARD_QUERY_H
...
#endif // SERVICES_EDM_INCLUDE_QUERY_POLICY_DISALLOW_EXTERNAL_MEMORY_CARD_QUERY_H