...
#ifndef SERVICES_EDM_INCLUDE_EDM_ENTERPRISE_ADMIN_CONN_MANAGER_H_
#define SERVICES_EDM_INCLUDE_EDM_ENTERPRISE_ADMIN_CONN_MANAGER_H_
...
#endif // SERVICES_EDM_INCLUDE_EDM_ENTERPRISE_ADMIN_CONN_MANAGER_H_