...
#ifndef SERVICES_EDM_INCLUDE_EDM_ENTERPRISE_ADMIN_PROXY_H_
#define SERVICES_EDM_INCLUDE_EDM_ENTERPRISE_ADMIN_PROXY_H_
...
#endif // SERVICES_EDM_INCLUDE_EDM_ENTERPRISE_ADMIN_PROXY_H_
