...
#ifndef SERVICES_EDM_INCLUDE_PERSISENT_PLUGIN_WATERMARK_IMAGE_SERIALIZER_H
#define SERVICES_EDM_INCLUDE_PERSISENT_PLUGIN_WATERMARK_IMAGE_SERIALIZER_H
...
#endif // SERVICES_EDM_INCLUDE_PERSISENT_PLUGIN_WATERMARK_IMAGE_SERIALIZER_H
