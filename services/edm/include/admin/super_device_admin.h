...
#ifndef SERVICES_EDM_INCLUDE_ADMIN_SUPER_DEVICE_ADMIN_H
#define SERVICES_EDM_INCLUDE_ADMIN_SUPER_DEVICE_ADMIN_H

#include "admin.h"

namespace OHOS {
namespace EDM {
class SuperDeviceAdmin : public Admin {
public:
    SuperDeviceAdmin(const AdminInfo& adminInfo);
    ~SuperDeviceAdmin() override = default;
    bool IsDisallowedUninstall() const override;
...
#endif // SERVICES_EDM_INCLUDE_ADMIN_SUPER_DEVICE_ADMIN_H
