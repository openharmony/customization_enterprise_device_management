...
namespace EDM {
namespace TEST {
class SingleExecuteStrategyTest : public testing::Test {
public:
    void SetUp() override {}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SingleExecuteStrategyTest, TestOnGetExecuteWhenFirstIfEstablished, TestSize.Level1)
{
    ...
    std::unique_ptr<SingleExecuteStrategy> singleExecuteStrategy = std::make_unique<SingleExecuteStrategy>();
    ErrCode eRet = singleExecuteStrategy->OnGetExecute(funcCode, policyData, data, reply, userId);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SingleExecuteStrategyTest, TestOnGetExecuteWhenSecondIfEstablished, TestSize.Level1)
{
    std::string policyData("policyData");
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SingleExecuteStrategyTest, TestOnSetExecuteWhenFirstIfEstablished, TestSize.Level1)
{
    ...
    std::uint32_t funcCode = 0;
    std::unique_ptr<SingleExecuteStrategy> singleExecuteStrategy = std::make_unique<SingleExecuteStrategy>();
    ErrCode eRet = singleExecuteStrategy->OnSetExecute(funcCode, data, reply, policyData, userId);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SingleExecuteStrategyTest, TestOnSetExecuteWhenSecondIfEstablished, TestSize.Level1)
{
    HandlePolicyData policyData;
    MessageParcel data;
    MessageParcel reply;
