...
#ifndef EDM_UNIT_TEST_SERVICES_EDM_PLUGIN_PERMISSION_HAP_CALL_PLUGIN_SET_POLICY_SUCCESS_TEST_H
#define EDM_UNIT_TEST_SERVICES_EDM_PLUGIN_PERMISSION_HAP_CALL_PLUGIN_SET_POLICY_SUCCESS_TEST_H
...
namespace EDM {
namespace TEST {
class HapCallPluginSetPolicySuccessTest : public testing::TestWithParam<TestParam> {
public:
    void SetUp() override;
...
#endif // EDM_UNIT_TEST_SERVICES_EDM_PLUGIN_PERMISSION_HAP_CALL_PLUGIN_SET_POLICY_SUCCESS_TEST_H