...
#ifndef EDM_UNIT_TEST_SERVICES_EDM_PLUGIN_PERMISSION_HAP_CALL_PLUGIN_SET_POLICY_PERMISSION_DENIED_TEST_H
#define EDM_UNIT_TEST_SERVICES_EDM_PLUGIN_PERMISSION_HAP_CALL_PLUGIN_SET_POLICY_PERMISSION_DENIED_TEST_H
...
namespace EDM {
namespace TEST {
class HapCallPluginSetPolicyPermissionDeniedTest : public testing::TestWithParam<TestParam> {
public:
    void SetUp() override;
...
#endif // EDM_UNIT_TEST_SERVICES_EDM_PLUGIN_PERMISSION_HAP_CALL_PLUGIN_SET_POLICY_PERMISSION_DENIED_TEST_H