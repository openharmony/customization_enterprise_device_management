...
#include "hap_call_plugin_set_policy_success_test.h"
...
void HapCallPluginSetPolicySuccessTest::SetUp()
{
...
void HapCallPluginSetPolicySuccessTest::TearDown()
{
...
INSTANTIATE_TEST_CASE_P(TestWithParam, HapCallPluginSetPolicySuccessTest, testing::ValuesIn(std::vector<TestParam>({
 ...
 * @tc.type: FUNC
 */
HWTEST_P(HapCallPluginSetPolicySuccessTest, PermissionCheckTest, TestSize.Level1)
{
    auto param = GetParam();
    // 激活Admin
