...
#include "hap_call_plugin_get_policy_permission_denied_test.h"
...
void HapCallPluginGetPolicyPermissionDeniedTest::SetUp()
{
...
void HapCallPluginGetPolicyPermissionDeniedTest::TearDown()
{
...
INSTANTIATE_TEST_CASE_P(TestWithParam, HapCallPluginGetPolicyPermissionDeniedTest,
 ...
 * @tc.type: FUNC
 */
HWTEST_P(HapCallPluginGetPolicyPermissionDeniedTest, PermissionCheckTest, TestSize.Level1)
{
    auto param = GetParam();
    // 激活Admin
