...
#include "hap_call_plugin_set_policy_permission_denied_test.h"
...
void HapCallPluginSetPolicyPermissionDeniedTest::TearDown()
{
...
INSTANTIATE_TEST_CASE_P(TestWithParam, HapCallPluginSetPolicyPermissionDeniedTest,
    testing::ValuesIn(std::vector<TestParam>(
{
    ...
    TestParam(EdmInterfaceCode::SET_BROWSER_POLICIES, std::make_shared<SetBrowserPoliciesPlugin>(),
        AdminType::ENT, true, "", ""),
    TestParam(EdmInterfaceCode::SET_BROWSER_POLICIES, std::make_shared<SetBrowserPoliciesPlugin>(),
        AdminType::ENT, false, "", ""),

    TestParam(EdmInterfaceCode::DISABLE_MTP_SERVER, std::make_shared<DisableMtpServerPlugin>(),
        AdminType::ENT, false, "", ""),
    TestParam(EdmInterfaceCode::DISABLE_MTP_SERVER, std::make_shared<DisableMtpServerPlugin>(),
        AdminType::ENT, true, "", ""),
    TestParam(EdmInterfaceCode::DISABLE_MTP_SERVER, std::make_shared<DisableMtpServerPlugin>(),
    ...
    TestParam(EdmInterfaceCode::USB_READ_ONLY, std::make_shared<UsbReadOnlyPlugin>(),
        AdminType::ENT, true, "", EdmPermission::PERMISSION_PERSONAL_MANAGE_RESTRICTIONS),
    TestParam(EdmInterfaceCode::USB_READ_ONLY, std::make_shared<UsbReadOnlyPlugin>(),
        AdminType::BYOD, false, "", EdmPermission::PERMISSION_ENTERPRISE_MANAGE_USB),
    TestParam(EdmInterfaceCode::USB_READ_ONLY, std::make_shared<UsbReadOnlyPlugin>(),
        AdminType::BYOD, true, "", EdmPermission::PERMISSION_ENTERPRISE_MANAGE_USB),
})));
 ...
 * @tc.type: FUNC
 */
HWTEST_P(HapCallPluginSetPolicyPermissionDeniedTest, PermissionCheckTest, TestSize.Level1)
{
    auto param = GetParam();
    // 激活Admin
    ...
    uint32_t code = POLICY_FUNC_CODE((std::uint32_t)FuncOperateType::SET, param.GetPluginCode());
    MessageParcel data;
    MessageParcel reply;
