...
#include "turnoff_wifi_plugin_test.h"
...
namespace EDM {
namespace TEST {
void TurnOffWifiTest::SetUpTestSuite(void)
{
    Utils::SetEdmInitialEnv();
}
  
void TurnOffWifiTest::TearDownTestSuite(void)
{
 ...
 * @tc.desc: Test TurnOffWifiPlugin::OnSetPolicy function sucess.
 * @tc.type: FUNC
 */
