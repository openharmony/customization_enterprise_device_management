...
namespace EDM {
namespace TEST {
const std::string PERSIST_EDM_MAINTENANCE_MODE = "persist.edm.random_mac_address_disable";
class DisallowRandomMacAddressPluginTest : public testing::Test {
protected:
...
void DisallowRandomMacAddressPluginTest::SetUpTestSuite(void)
{
    Utils::SetEdmServiceEnable();
    Utils::SetEdmInitialEnv();
}

void DisallowRandomMacAddressPluginTest::TearDownTestSuite(void)
{
...
HWTEST_F(DisallowRandomMacAddressPluginTest, TestDisallowRandomMacAddressPluginTestSetTrue, TestSize.Level1)
{
    ...
    MessageParcel reply;
    data.WriteBool(true);
    std::shared_ptr<IPlugin> plugin = std::make_shared<DisallowRandomMacAddressPlugin>();
