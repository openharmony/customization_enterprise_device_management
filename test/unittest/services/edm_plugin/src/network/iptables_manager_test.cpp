...
HWTEST_F(IptablesManagerTest, TestAddFilewallSuccess, TestSize.Level1)
{
    ...
    std::vector<FirewallRule> validRules{
        ...
        {Direction::INPUT, Action::REJECT, Protocol::UDP, "192.168.2.100", "192.168.2.200", "80", "90", "",
            Family::IPV4, LogType::NFLOG},
        {Direction::INPUT, Action::ALLOW, Protocol::TCP, "192.168.2.100", "", "", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::OUTPUT, Action::DENY, Protocol::ICMP, "", "", "", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::OUTPUT, Action::REJECT, Protocol::ICMP, "", "", "", "", "", Family::IPV4, LogType::NFLOG},
        ...
        {Direction::OUTPUT, Action::REJECT, Protocol::INVALID, "", "192.168.1.1/20", "", "", "", Family::IPV4,
            LogType::NFLOG},
        {Direction::FORWARD, Action::DENY, Protocol::ICMP, "", "", "", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::FORWARD, Action::REJECT, Protocol::ICMP, "", "", "", "", "", Family::IPV4, LogType::NFLOG},
        ...
        {Direction::FORWARD, Action::REJECT, Protocol::INVALID, "", "192.168.1.1/20", "", "", "", Family::IPV4,
            LogType::NFLOG},
        {Direction::INPUT, Action::ALLOW, Protocol::INVALID, "", "", "80", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::INPUT, Action::DENY, Protocol::INVALID, "", "", "80:90", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::INPUT, Action::REJECT, Protocol::INVALID, "", "", "80:90", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::INPUT, Action::ALLOW, Protocol::INVALID, "", "", "80,90", "99", "", Family::IPV4, LogType::NFLOG},
        {Direction::INPUT, Action::ALLOW, Protocol::INVALID, "", "", "", "901", "", Family::IPV4, LogType::NFLOG},
        {Direction::INPUT, Action::ALLOW, Protocol::INVALID, "", "", "", "901:1000", "", Family::IPV4, LogType::NFLOG},
        {Direction::INPUT, Action::ALLOW, Protocol::INVALID, "", "", "", "901,1000", "", Family::IPV4, LogType::NFLOG},
        {Direction::OUTPUT, Action::ALLOW, Protocol::INVALID, "", "", "", "", "5555", Family::IPV4, LogType::NFLOG}};
...
HWTEST_F(IptablesManagerTest, TestAddFilewallFail, TestSize.Level1)
{
    ...
    std::vector<FirewallRule> invalidRules{
        {Direction::INPUT, Action::INVALID, Protocol::INVALID, "", "", "", "", "9999", Family::IPV4, LogType::NFLOG},
        {Direction::FORWARD, Action::INVALID, Protocol::INVALID, "", "", "", "", "9999", Family::IPV4, LogType::NFLOG},
...
HWTEST_F(IptablesManagerTest, TestAddFilewallError, TestSize.Level1)
{
    ...
    std::vector<FirewallRule> validRules{
        ...
        {Direction::INPUT, Action::DENY, Protocol::INVALID, "", "", "80-90", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::INPUT, Action::REJECT, Protocol::INVALID, "", "", "80-90", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::INPUT, Action::ALLOW, Protocol::INVALID, "", "", "80,90", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::INPUT, Action::ALLOW, Protocol::INVALID, "", "", "", "901", "", Family::IPV4, LogType::NFLOG},
        {Direction::INPUT, Action::ALLOW, Protocol::INVALID, "", "", "", "901-1000", "", Family::IPV4, LogType::NFLOG},
        {Direction::INPUT, Action::ALLOW, Protocol::INVALID, "", "", "", "901,1000", "", Family::IPV4, LogType::NFLOG},
        {Direction::OUTPUT, Action::ALLOW, Protocol::INVALID, "", "", "", "", "5555", Family::IPV4, LogType::NFLOG}};
...
HWTEST_F(IptablesManagerTest, TestAddFilewallParamError, TestSize.Level1)
{
    ...
    std::vector<FirewallRule> validRules{
        {Direction::OUTPUT, Action::INVALID, Protocol::INVALID, "", "", "", "", "5555", Family::IPV4, LogType::NFLOG},
        {Direction::FORWARD, Action::INVALID, Protocol::INVALID, "", "", "", "", "5555", Family::IPV4, LogType::NFLOG},
...
HWTEST_F(IptablesManagerTest, TestRemoveFilewallFail, TestSize.Level1)
{
    ...
    std::vector<FirewallRule> invalidRules{
        {Direction::INPUT, Action::INVALID, Protocol::INVALID, "", "", "", "", "9999", Family::IPV4, LogType::NFLOG},
        {Direction::FORWARD, Action::INVALID, Protocol::INVALID, "", "", "", "", "9999", Family::IPV4, LogType::NFLOG},
        {Direction::INVALID, Action::ALLOW, Protocol::INVALID, "", "", "", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::INVALID, Action::INVALID, Protocol::ALL, "", "", "", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::INVALID, Action::INVALID, Protocol::UDP, "", "", "", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::INVALID, Action::INVALID, Protocol::TCP, "", "", "", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::INVALID, Action::INVALID, Protocol::ICMP, "", "", "", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::INVALID, Action::INVALID, Protocol::INVALID, "192.168.1.1", "", "", "", "", Family::IPV4,
            LogType::NFLOG},
        {Direction::INVALID, Action::INVALID, Protocol::INVALID, "", "192.168.1.1", "", "", "", Family::IPV4,
            LogType::NFLOG},
        {Direction::INVALID, Action::INVALID, Protocol::INVALID, "", "", "80", "", "", Family::IPV4, LogType::NFLOG},
        {Direction::INVALID, Action::INVALID, Protocol::INVALID, "", "", "", "901", "", Family::IPV4, LogType::NFLOG},
...
HWTEST_F(IptablesManagerTest, TestAddDomainFilterSuccess, TestSize.Level1)
{
    ...
    std::vector<DomainFilterRule> validRules{
        {Action::ALLOW, "1000", "www.example.com", Direction::INVALID, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "1000", "www.example.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "1000", "www.example.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "", "www.example.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "", "www.example.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "", "www.example.com", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "", "www.example.com", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
    };
    for (const auto &item : validRules) {
...
HWTEST_F(IptablesManagerTest, TestAddDomainFilterFail, TestSize.Level1)
{
    ...
    std::vector<DomainFilterRule> invalidRules{
        {Action::ALLOW, "1000", "", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::INVALID, "1000", "www.example.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "1000", "www.ex||ample.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "1000", "www.ex/ample.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::INVALID, "1000", invalidDomainName, Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "1000", "", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::INVALID, "1000", "www.example.com", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "1000", "www.ex||ample.com", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "1000", "www.ex/ample.com", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::INVALID, "1000", invalidDomainName, Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "1000", "", Direction::INVALID, Family::IPV4, LogType::NFLOG},
        {Action::INVALID, "1000", "www.example.com", Direction::INVALID, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "1000", "www.ex||ample.com", Direction::INVALID, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "1000", "www.ex/ample.com", Direction::INVALID, Family::IPV4, LogType::NFLOG},
        {Action::INVALID, "1000", invalidDomainName, Direction::INVALID, Family::IPV4, LogType::NFLOG}};
    for (const auto &item : invalidRules) {
...
HWTEST_F(IptablesManagerTest, TestRemoveDomainFilterSuccess, TestSize.Level1)
{
    ...
    std::vector<DomainFilterRule> validRules{
        {Action::INVALID, "", "", Direction::INVALID, Family::IPV4, LogType::NFLOG},
        {Action::INVALID, "", "", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "", "", Direction::INVALID, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "", "", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "", "", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "1000", "www.example.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "1000", "www.example.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "", "www.example.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "", "www.example.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::INVALID, "", "", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "", "", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "", "", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "", "www.example.com", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "", "www.example.com", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
    };
    for (const auto &item : validRules) {
...
HWTEST_F(IptablesManagerTest, TestRemoveDomainFilterFail, TestSize.Level1)
{
    ...
    std::vector<DomainFilterRule> invalidRules{
        {Action::ALLOW, "1000", "", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "1000", "", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::INVALID, "", "www.example.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::INVALID, "1000", "www.example.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "1000", "www.ex||ample.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "1000", "www.ex/ample.com", Direction::OUTPUT, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "1000", "", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "1000", "", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::INVALID, "", "www.example.com", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::INVALID, "1000", "www.example.com", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::DENY, "1000", "www.ex||ample.com", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
        {Action::ALLOW, "1000", "www.ex/ample.com", Direction::FORWARD, Family::IPV4, LogType::NFLOG},
    };
