...
#include "disallow_vpn_plugin_test.h"
...
namespace EDM {
namespace TEST {
void DisallowVPNPluginTest::SetUpTestSuite(void)
{
    Utils::SetEdmInitialEnv();
}

void DisallowVPNPluginTest::TearDownTestSuite(void)
{
...
/**
 * @tc.name: TestDisallowVPNPlugin
 * @tc.desc: Test DisallowVPNPlugin::OnSetPolicy function.
 * @tc.type: FUNC
 */
HWTEST_F(DisallowVPNPluginTest, TestDisallowVPNPluginTest001, TestSize.Level1)
{
    MessageParcel data;
    MessageParcel reply;
    data.WriteBool(true);
