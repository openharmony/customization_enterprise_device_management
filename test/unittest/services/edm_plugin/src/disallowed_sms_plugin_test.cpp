...
INSTANTIATE_TEST_SUITE_P(TestOnSetPolicy, DisallowedSMSPluginTest,
    testing::ValuesIn(std::vector<std::pair<std::shared_ptr<IPlugin>, EdmInterfaceCode>>({
        {std::make_shared<DisallowedSMSPlugin>(), EdmInterfaceCode::DISALLOWED_SMS},
 ...
 * @tc.type: FUNC
 */
HWTEST_P(DisallowedSMSPluginTest, TestOnSetPolicy, TestSize.Level1)
{
    auto param = GetParam();
    MessageParcel data;
    MessageParcel reply;
