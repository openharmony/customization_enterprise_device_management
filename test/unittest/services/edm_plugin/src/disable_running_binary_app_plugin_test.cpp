...
namespace EDM {
namespace TEST {
class DisableRunningBinaryAppPluginTest : public testing::Test {
protected:
...
void DisableRunningBinaryAppPluginTest::SetUpTestSuite(void)
{
    Utils::SetEdmInitialEnv();
}

void DisableRunningBinaryAppPluginTest::TearDownTestSuite(void)
{
