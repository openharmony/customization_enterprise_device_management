...
namespace EDM {
namespace TEST {
class DisallowModifyAPNPluginTest
...
void DisallowModifyAPNPluginTest::SetUpTestSuite(void)
{
    Utils::SetEdmInitialEnv();
}

void DisallowModifyAPNPluginTest::TearDownTestSuite(void)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_P(DisallowModifyAPNPluginTest, TestOnSetPolicy, TestSize.Level1)
{
    auto param = GetParam();
    MessageParcel data;
    MessageParcel reply;
