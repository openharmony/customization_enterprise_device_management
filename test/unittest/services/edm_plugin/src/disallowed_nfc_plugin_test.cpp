...
void DisallowedNFCPluginTest::SetUpTestSuite(void)
{
    Utils::SetEdmInitialEnv();
}

void DisallowedNFCPluginTest::TearDownTestSuite(void)
{
...
INSTANTIATE_TEST_SUITE_P(TestOnSetPolicy, DisallowedNFCPluginTest,
    testing::ValuesIn(std::vector<std::pair<std::shared_ptr<IPlugin>, EdmInterfaceCode>>({
        {DisallowedNFCPlugin::GetPlugin(), EdmInterfaceCode::DISALLOWED_NFC}
    })));
...
* @tc.type: FUNC
*/
HWTEST_P(DisallowedNFCPluginTest, TestOnSetPolicy, TestSize.Level1)
{
    auto param = GetParam();
    MessageParcel data;
    MessageParcel reply;
