...
class SetEyeComfortModePluginTest : public testing::Test {
protected:
...
void SetEyeComfortModePluginTest::SetUpTestSuite(void)
{
    Utils::SetEdmServiceEnable();
    Utils::SetEdmInitialEnv();
}

void SetEyeComfortModePluginTest::TearDownTestSuite(void)
{
