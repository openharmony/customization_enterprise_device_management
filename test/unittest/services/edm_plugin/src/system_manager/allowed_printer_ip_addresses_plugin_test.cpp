...
/**
 * @tc.name: TestOnChangedPolicyDone_GlobalChanged
 * @tc.desc: Test OnChangedPolicyDone with isGlobalChanged=true triggers notification.
 * @tc.type: FUNC
 */
HWTEST_F(AllowedPrinterIpAddressesPluginTest, TestOnChangedPolicyDone_GlobalChanged, TestSize.Level1)
{
    AllowedPrinterIPAddressesPlugin plugin;
...
/**
 * @tc.name: TestOnChangedPolicyDone_NotGlobalChanged
 * @tc.desc: Test OnChangedPolicyDone with isGlobalChanged=false does not notify.
 * @tc.type: FUNC
 */
HWTEST_F(AllowedPrinterIpAddressesPluginTest, TestOnChangedPolicyDone_NotGlobalChanged, TestSize.Level1)
{
    AllowedPrinterIPAddressesPlugin plugin;
...
/**
 * @tc.name: TestOnAdminRemoveDone_DeviceType
 * @tc.desc: Test OnAdminRemoveDone for device-level plugin.
 * @tc.type: FUNC
 */
HWTEST_F(AllowedPrinterIpAddressesPluginTest, TestOnAdminRemoveDone_DeviceType, TestSize.Level1)
{
    AllowedPrinterIPAddressesPlugin plugin;
    plugin.OnAdminRemoveDone();
}
 
/**
 * @tc.name: TestForAccountOnChangedPolicyDone_GlobalChanged
 * @tc.desc: Test AllowedPrinterIPAddressesForAccountPlugin OnChangedPolicyDone with isGlobalChanged=true.
 * @tc.type: FUNC
 */
HWTEST_F(AllowedPrinterIpAddressesPluginTest, TestForAccountOnChangedPolicyDone_GlobalChanged, TestSize.Level1)
{
    AllowedPrinterIPAddressesForAccountPlugin plugin;
    std::vector<std::string> data = {"192.168.1.1"};
    plugin.OnChangedPolicyDone(data, true, DEFAULT_USER_ID);
}
 
/**
 * @tc.name: TestForAccountOnChangedPolicyDone_NotGlobalChanged
 * @tc.desc: Test AllowedPrinterIPAddressesForAccountPlugin OnChangedPolicyDone with isGlobalChanged=false.
 * @tc.type: FUNC
 */
HWTEST_F(AllowedPrinterIpAddressesPluginTest, TestForAccountOnChangedPolicyDone_NotGlobalChanged, TestSize.Level1)
{
    AllowedPrinterIPAddressesForAccountPlugin plugin;
    std::vector<std::string> data = {"192.168.1.1"};
    plugin.OnChangedPolicyDone(data, false, DEFAULT_USER_ID);
}
 
/**
 * @tc.name: TestForAccountOnAdminRemoveDone
 * @tc.desc: Test AllowedPrinterIPAddressesForAccountPlugin OnAdminRemoveDone.
 * @tc.type: FUNC
 */
HWTEST_F(AllowedPrinterIpAddressesPluginTest, TestForAccountOnAdminRemoveDone, TestSize.Level1)
{
    AllowedPrinterIPAddressesForAccountPlugin plugin;
    std::vector<std::string> data = {"192.168.1.1"};
    plugin.OnAdminRemoveDone("admin", data, DEFAULT_USER_ID);
}
} // namespace TEST
} // namespace EDM
} // namespace OHOS