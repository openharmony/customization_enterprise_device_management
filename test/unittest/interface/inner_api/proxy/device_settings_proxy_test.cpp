...
/**
 * @tc.name: TestSetDeviceNameForAccountSuc
 * @tc.desc: Test SetDeviceNameForAccount func.
 * @tc.type: FUNC
 */
HWTEST_F(DeviceSettingsProxyTest, TestSetDeviceNameForAccountSuc, TestSize.Level1)
{
    AppExecFwk::ElementName admin;
    admin.SetBundleName(ADMIN_PACKAGENAME);
    EXPECT_CALL(*object_, SendRequest(_, _, _, _))
...
/**
 * @tc.name: TestSetDeviveNameForAccountFail
 * @tc.desc: Test SetDeviceNameForAccount func.
 * @tc.type: FUNC
 */
HWTEST_F(DeviceSettingsProxyTest, TestSetDeviveNameForAccountFail, TestSize.Level1)
{
    Utils::SetEdmServiceDisable();
    AppExecFwk::ElementName admin;
    admin.SetBundleName(ADMIN_PACKAGENAME);
...
/**
 * @tc.name: TestGetDeviceNameForAccountSuc
 * @tc.desc: Test GetDeviceNameForAccount func.
 * @tc.type: FUNC
 */
HWTEST_F(DeviceSettingsProxyTest, TestGetDeviceNameForAccountSuc, TestSize.Level1)
{
    AppExecFwk::ElementName admin;
    admin.SetBundleName(ADMIN_PACKAGENAME);
    EXPECT_CALL(*object_, SendRequest(_, _, _, _))
...
/**
 * @tc.name: TestGetDeviceNameForAccountFail
 * @tc.desc: Test GetDeviceNameForAccount func.
 * @tc.type: FUNC
 */
HWTEST_F(DeviceSettingsProxyTest, TestGetDeviceNameForAccountFail, TestSize.Level1)
{
    Utils::SetEdmServiceDisable();
    AppExecFwk::ElementName admin;
    admin.SetBundleName(ADMIN_PACKAGENAME);
